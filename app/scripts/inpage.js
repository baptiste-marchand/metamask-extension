...
if (shouldInjectProvider()) {
  ...
  metamaskStream = new WindowPostMessageStream({
    name: INPAGE,
...
class MetaMaskWallet {
  ...
  chains = [SOLANA_MAINNET_CHAIN, SOLANA_DEVNET_CHAIN, SOLANA_TESTNET_CHAIN];
  ...
  #connect = async () => {
    if (!this.accounts.length) {
      const accounts = await this.metaMaskSdk.connect({
        extensionId: 'icaoabcfdgiaonggejfnaoomkoaofkhm', // TODO: replace with your ID
      });
  ...
  #signTransaction = async (/* ...inputs */) => {
    ...
    return await new Promise((_, reject) =>
      reject(new Error('signTransaction: Not implemented')),
    );
  };
  ...
  #signMessage = async (...inputs) => {
    ...
    const signature = await this.metaMaskSdk.invokeMethod({
      scope: this.scope,
      request: {
        method: 'signMessage',
        params: {
...
async function registerMetaMaskWalletAdapter() {
  console.log('registerMetaMaskWalletAdapter: start');
  ...
  console.log('registerMetaMaskWalletAdapter: end');
}

registerMetaMaskWalletAdapter();
